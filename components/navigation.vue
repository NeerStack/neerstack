                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6">
                        <div class="modal-body__inner-content">
                            <h4>
                                <!-- <span>ProduceMart</span> -->
                                Enitars (formerly known as MageHub)
                            </h4>
                            <p>Enitars is your all-in-one AI companion, harnessing the cutting-edge OpenAI Assistant API to bring a world of AI tools directly to your fingertips.</p>
